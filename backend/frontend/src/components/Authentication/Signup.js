...
const Signup = () => {
 ...
 // const [picLoading, setPicLoading] = useState(false);
  ...
  //   setPic("");
    ...
    //   data.append("cloud_name", "dt3mh9bqw");
    //   fetch("https://api.cloudinary.com/v1_1/dt3mh9bqw/image/upload", {
    //     method: "post",
    //     body: data,
    //   })
    //     .then((res) => res.json())
...
//       reader.onloadend = () => {
//         fetch("http://localhost:3001/api/cloudinary/upload", {
//           method: "POST",
//           headers: {
//             "Content-Type": "application/json",
//           },
...
//               description: "Try again or check backend.",
//               status: "error",
//               duration: 5000,
//               isClosable: true,
//               position: "bottom",
